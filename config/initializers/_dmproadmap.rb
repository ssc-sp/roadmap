...
module DMPRoadmap
  ...
  class Application < Rails::Application
    ...
    config.x.organisation.name = 'Shared Services Canada'
    # Your organisation's abbreviation
    config.x.organisation.abbreviation = 'SSC'
    # Your organisation's homepage, used in some of the public facing pages
    config.x.organisation.url = 'https://github.com/ssc-sp/roadmap'
    # Your organisation's legal (official) name - used in the copyright portion of the footer
    config.x.organisation.copywrite_name = 'Shared Services Canada (SSC)'
